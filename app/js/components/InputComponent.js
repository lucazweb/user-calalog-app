class InputComponent{
    ...
    constructor(id, name, type, parentId, className = null, placeholder = null, validatorMessage = null, required = true){
        ...
        if(required) this._input.setAttribute('required', 'required');
